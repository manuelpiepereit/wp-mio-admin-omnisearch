...
var _default = {
  ...
  watch: {
    searchResults: function searchResults(data) {
      this.searchResults = data; // select first result
  ...
  methods: {
    ...
    searchDebounced: (0, _lodash.default)(function (e, vm) {
      if ('' === vm.searchTerm) {
    ...
    // opens page
    viewResult: function viewResult(link, e) {
      window.open(link, '_blank');
    },
    // opens edit page
    editResult: function editResult(link, e) {
      window.open(link, '_self');
    },
    // opens edit page based on selection
    editSelectedResult: function editSelectedResult(e) {
      if (this.searchResults == null || this.searchResults.length === 0) {
        return;
      }

      var link_edit = this.searchResults[this.resultSelected].link_edit;
    ...
    selectNext: function selectNext(e) {
    ...
    selectPrev: function selectPrev(e) {
      e.target.selectionStart = e.target.value.length;
...
exports.default = _default;
        var $7d8c41 = exports.default || module.exports;
      
      if (typeof $7d8c41 === 'function') {
        $7d8c41 = $7d8c41.options;
      }
    
        /* template */
        Object.assign($7d8c41, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "li",
    {
      class: _vm.isActive ? "mio-omnisearch hover" : "mio-omnisearch",
      attrs: { id: "wp-admin-bar-mio-omnisearch" }
    },
    [
      _c(
        "div",
        {
          staticClass: "mio-omnisearch__icon ab-item",
          on: { click: _vm.toggleActive }
        },
        [_c("span", { staticClass: "ab-icon" })]
      ),
      _vm._v(" "),
      _vm.isActive
        ? _c(
            "div",
            {
              ...
              staticClass: "mio-omnisearch__sub"
            },
            [
              _c("div", { staticClass: "mio-omnisearch__inputs" }, [
                _c("form", { attrs: { method: "post" } }, [
                  _c("div", { staticClass: "input-text-wrap" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                      ...
                      on: {
                        ...
                        keypress: function($event) {
                          ...
                          $event.preventDefault()
                          return _vm.editSelectedResult($event)
                        },
                  ...
                  _c("div", { staticClass: "input-text-wrap" }, [
                    _c(
                      ...
                      _vm._l(_vm.postTypes, function(type) {
                        return _c(
                          "option",
              ...
              _vm._v(" "),
              _vm.searchResults
                ? _c("div", { staticClass: "mio-omnisearch__results" }, [
                    _c(
                      "div",
                      { staticClass: "mio-omnisearch__results__heading" },
                      [
                        _vm._v(
                          "\n\t\t\t\t" +
                            _vm._s(_vm.ui.searchResults) +
                            "\n\t\t\t\t"
                        ),
                        _vm.searchResults.length
                          ? _c("span", [_vm._v(_vm._s(_vm.ui.openInfo))])
                          : _vm._e()
                      ]
                    ),
                    _vm._v(" "),
                    _vm.searchResults.length
                      ? _c(
                          "ul",
                          { staticClass: "mio-omnisearch__results__list" },
                          _vm._l(_vm.searchResults, function(post, index) {
                            return _c(
                              "li",
                              {
                                ...
                                class: [
                                  "post",
                                  _vm.resultSelected === index
                                    ? "-is-selected"
                                    : ""
                                ],
                                attrs: { id: "post-" + post.id },
                                on: {
                                  click: function($event) {
                                    return _vm.editResult(
                                      post.link_edit,
                                      $event
                                    )
                                  },
                                  mouseenter: function($event) {
                                    return _vm.selectResult(index)
                                  },
                                  mouseleave: function($event) {
                                    return _vm.selectResult(null)
                                  }
                                }
                              },
                              [
                                ...
                                _c("div", { staticClass: "post__content" }, [
                                  ...
                                  _c("br"),
                                  _vm._v(" "),
                                  _c("a", { attrs: { href: post.link_edit } }, [
                                    _vm._v(_vm._s(_vm.ui.edit))
                                  ]),
                                  _vm._v(" |\n\t\t\t\t\t\t"),
                                  _c(
                                    "a",
                                    ...
                                    [_vm._v(_vm._s(_vm.ui.view))]
                                  )
                                ]),
                                _vm._v(" "),
                                _c("div", { staticClass: "post__type" }, [
                      ...
                      : _c(
                          ...
                          { staticClass: "mio-omnisearch__results__list" },
                          [
                            _c("li", { staticClass: "post" }, [
                              _vm._v(_vm._s(_vm.ui.nothingFound))
                            ])
                          ]
                        )
                  ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7d8c41', $7d8c41);
          } else {
            api.reload('$7d8c41', $7d8c41);
          }
        }
...
},{"lodash.debounce":"../node_modules/lodash.debounce/index.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
_vue.default.directive("click-outside", {
  bind: function bind(el, binding, vnode) {
    el.clickOutsideEvent = function (event) {
      var exludeItem = event.target.closest(".mio-omnisearch") === null; // here I check that click was outside the el and his childrens
