...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("lodash.debounce"));function t(e){return e&&e.__esModule?e:{default:e}}var s={name:"mioAdminOmniSearchApp",data:function(){return{isActive:!1,searchTerm:"",searchType:"any",searchResults:null,resultSelected:null,postTypes:mio_omnisearch.types,ui:mio_omnisearch.ui}},watch:{searchResults:function(e){this.searchResults=e,this.resultSelected=null!=this.searchResults&&0!==this.searchResults.length?0:null}},methods:{openSearch:function(e){this.isActive=!0,this.$nextTick(function(){this.$refs.search.focus()})},closeSearch:function(e){this.isActive=!1},toggleActive:function(e){this.isActive?this.closeSearch():this.openSearch()},onKeyDown:function(e){27!==e.keyCode||""===e.target.value&&this.closeSearch(e)},search:function(e){13!==e.keyCode&&(38!==e.keyCode?40!==e.keyCode?this.searchDebounced(e,this):this.selectNext(e):this.selectPrev(e))},searchDebounced:(0,e.default)(function(e,t){if(""!==t.searchTerm){var s="/wp-json/mio/omnisearch?search="+t.searchTerm+"&type="+t.searchType;fetch(s).then(function(e){return e.json()}).then(function(e){e.code?t.searchResults=[]:t.searchResults=e})}else t.searchResults=null},300),viewResult:function(e,t){window.open(e,"_blank")},editResult:function(e,t){window.open(e,"_self")},editSelectedResult:function(e){if(null!=this.searchResults&&0!==this.searchResults.length){var t=this.searchResults[this.resultSelected].link_edit;window.open(t,"_self")}},selectResult:function(e){this.resultSelected=e},selectNext:function(e){e.target.selectionStart=e.target.value.length,this.resultSelected<this.searchResults.length-1&&this.resultSelected++},selectPrev:function(e){e.target.selectionStart=e.target.value.length,this.resultSelected>=1&&this.resultSelected--}}};exports.default=s;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,t=e.$createElement,s=e._self._c||t;return s("li",{class:e.isActive?"mio-omnisearch hover":"mio-omnisearch",attrs:{id:"wp-admin-bar-mio-omnisearch"}},[s("div",{staticClass:"mio-omnisearch__icon ab-item",on:{click:e.toggleActive}},[s("span",{staticClass:"ab-icon"})]),e._v(" "),e.isActive?s("div",{directives:[{name:"click-outside",rawName:"v-click-outside",value:e.closeSearch,expression:"closeSearch"}],staticClass:"mio-omnisearch__sub"},[s("div",{staticClass:"mio-omnisearch__inputs"},[s("form",{attrs:{method:"post"}},[s("div",{staticClass:"input-text-wrap"},[s("input",{directives:[{name:"model",rawName:"v-model",value:e.searchTerm,expression:"searchTerm"}],ref:"search",attrs:{type:"search",name:"search_term",placeholder:e.ui.search,autocomplete:"off"},domProps:{value:e.searchTerm},on:{keyup:function(t){return t.preventDefault(),e.search(t)},keydown:e.onKeyDown,keypress:function(t){return!t.type.indexOf("key")&&e._k(t.keyCode,"enter",13,t.key,"Enter")?null:(t.preventDefault(),e.editSelectedResult(t))},input:function(t){t.target.composing||(e.searchTerm=t.target.value)}}})]),e._v(" "),s("div",{staticClass:"input-text-wrap"},[s("select",{directives:[{name:"model",rawName:"v-model",value:e.searchType,expression:"searchType"}],attrs:{name:"search_type"},on:{change:[function(t){var s=Array.prototype.filter.call(t.target.options,function(e){return e.selected}).map(function(e){return"_value"in e?e._value:e.value});e.searchType=t.target.multiple?s:s[0]},function(t){return t.preventDefault(),e.search(t)}]}},e._l(e.postTypes,function(t){return s("option",{key:t.name,domProps:{value:t.name}},[e._v(e._s(t.label))])}),0)])])]),e._v(" "),e.searchResults?s("div",{staticClass:"mio-omnisearch__results"},[s("div",{staticClass:"mio-omnisearch__results__heading"},[e._v(" "+e._s(e.ui.searchResults)+" "),e.searchResults.length?s("span",[e._v(e._s(e.ui.openInfo))]):e._e()]),e._v(" "),e.searchResults.length?s("ul",{staticClass:"mio-omnisearch__results__list"},e._l(e.searchResults,function(t,i){return s("li",{key:t.id,class:["post",e.resultSelected===i?"-is-selected":""],attrs:{id:"post-"+t.id},on:{click:function(s){return e.editResult(t.link_edit,s)},mouseenter:function(t){return e.selectResult(i)},mouseleave:function(t){return e.selectResult(null)}}},[s("div",{staticClass:"post__image"},[t.image?s("img",{staticClass:"post__image__img",attrs:{src:t.image,alt:""}}):s("div",{staticClass:"post__image__img"})]),e._v(" "),s("div",{staticClass:"post__content"},[s("a",{staticClass:"post__title",attrs:{href:t.link_edit}},[e._v(" "+e._s(t.title)+" "+e._s(""!==t.status?" — "+t.status:"")+" ")]),e._v(" "),s("br"),e._v(" "),s("a",{attrs:{href:t.link_edit}},[e._v(e._s(e.ui.edit))]),e._v(" | "),s("a",{attrs:{href:t.link_view,target:"_blank"},on:{click:function(s){return s.stopPropagation(),e.viewResult(t.link_view,s)}}},[e._v(e._s(e.ui.view))])]),e._v(" "),s("div",{staticClass:"post__type"},[e._v(e._s(t.type))])])}),0):s("ul",{staticClass:"mio-omnisearch__results__list"},[s("li",{staticClass:"post"},[e._v(e._s(e.ui.nothingFound))])])]):e._e()]):e._e()])},staticRenderFns:[],_compiled:!0,_scopeId:"data-v-7d8c41",functional:void 0});})();
},{"lodash.debounce":"PZFh"}],"Focm":[function(require,module,exports) {
"use strict";var e=t(require("vue")),n=t(require("./components/App.vue"));function t(e){return e&&e.__esModule?e:{default:e}}e.default.directive("click-outside",{bind:function(e,n,t){e.clickOutsideEvent=function(i){var c=null===i.target.closest(".mio-omnisearch");e!=i.target&&!e.contains(i.target)&&c&&t.context[n.expression](i)},document.body.addEventListener("click",e.clickOutsideEvent)},unbind:function(e){document.body.removeEventListener("click",e.clickOutsideEvent)}}),window.addEventListener("load",function(){new e.default({el:"#wp-admin-bar-mio-omnisearch-app",render:function(e){return e(n.default)}})});
},{"vue":"QPfz","./components/App.vue":"TC2m"}]},{},["Focm"], null)
